...
public class UserServiceTest2 {
    ...
    public void testCreerUtilisateur() throws ServiceException {
        ...
        Utilisateur utilisateur = new Utilisateur("akram", "benmouffok", "akrambenmouffok@email.com");

        // Configuration du comportement du mock (même si ici la méthode retourne void, pas besoin de thenReturn)
